...
// METODOS ESPECIFICOS
	 ...
	 * @param x eh o objeto que sera adicionado no topo da pilha
	...
	*/
 	public X getElemento() throws Exception
 	{
		if(this.topo==-1)
 		...
 		//return this.meuCloneDeX((X)this.pilha[this.topo]);
 		return (X)this.pilha[this.topo];
 	}
...
// METODOS OBRIGATORIOS
	...
	* @return int : retorna o um numero "unico" para cada Pilha diferente
	*/
	public int hashCode()
	{
		int ret = 1;
